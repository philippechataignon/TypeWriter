...
const int8_t input_pin[INPUT_NUM] = {33, 32, 31, 30, 29, 28, 26, 25, 24};
const int8_t output_pin[OUTPUT_NUM] = {23, 22, 21, 20, 17, 16, 15, 14};
...
const Combi mapping[256] = {
    ...
    { 8, 5, MOD_NO  },    // char 2
    { 0, 6, MOD_NO  },    // char 3
    { 0, 6, MOD_SHIFT  },    // char 4
    {-1, -1, MOD_NO},    // char 5 unmapped
    { 4, 4, MOD_CODE | MOD_DELAY },    // char 6
    { 6, 1, MOD_CODE | MOD_DELAY },    // char 7
    {-1, -1, MOD_NO},    // char 8 unmapped
    {-1, -1, MOD_NO},    // char 9 unmapped
    { 4, 6, MOD_NO | MOD_DELAY },    // char 10
    {-1, -1, MOD_NO},    // char 11 unmapped
    { 4, 6, MOD_CODE | MOD_DELAY },    // char 12
    { 4, 6, MOD_NO | MOD_DELAY },    // char 13
    ...
    { 3, 4, MOD_CODE | MOD_DELAY },    // char 21
    {-1, -1, MOD_NO},    // char 22 unmapped
    { 1, 5, MOD_CODE | MOD_DELAY },    // char 23
    { 0, 7, MOD_CODE | MOD_DELAY },    // char 24
    ...
    { 6, 0, MOD_SHIFT },    // char 39 : '
    { 0, 4, MOD_SHIFT },    // char 40 : (
    { 0, 5, MOD_SHIFT },    // char 41 : )
    { 2, 6, MOD_SHIFT },    // char 42 : *
    { 2, 6, MOD_NO },    // char 43 : +
    { 6, 2, MOD_NO },    // char 44 : ,
    { 7, 4, MOD_NO },    // char 45 : -
    { 6, 4, MOD_NO },    // char 46 : .
    { 1, 4, MOD_SHIFT },    // char 47 : /
    { 1, 5, MOD_NO },    // char 48 : 0
    ...
    { 1, 4, MOD_NO },    // char 55 : 7
    { 0, 4, MOD_NO },    // char 56 : 8
    { 0, 5, MOD_NO },    // char 57 : 9
    { 6, 4, MOD_SHIFT },    // char 58 : :
    { 6, 2, MOD_SHIFT },    // char 59 : ;
    {-1, -1, MOD_NO},    // char 60 unmapped
    { 1, 5, MOD_SHIFT },    // char 61 : =
    {-1, -1, MOD_NO},    // char 62 unmapped
    { 1, 6, MOD_SHIFT },    // char 63 : ?
    {-1, -1, MOD_NO},    // char 64 unmapped
    { 4, 3, MOD_SHIFT },    // char 65 : A
    { 6, 1, MOD_SHIFT },    // char 66 : B
    { 7, 3, MOD_SHIFT },    // char 67 : C
    { 5, 1, MOD_SHIFT },    // char 68 : D
    { 3, 0, MOD_SHIFT },    // char 69 : E
    { 4, 1, MOD_SHIFT },    // char 70 : F
    { 4, 0, MOD_SHIFT },    // char 71 : G
    { 5, 0, MOD_SHIFT },    // char 72 : H
    { 2, 4, MOD_SHIFT },    // char 73 : I
    { 5, 2, MOD_SHIFT },    // char 74 : J
    { 4, 2, MOD_SHIFT },    // char 75 : K
    { 4, 4, MOD_SHIFT },    // char 76 : L
    { 7, 2, MOD_SHIFT },    // char 77 : M
    { 7, 1, MOD_SHIFT },    // char 78 : N
    { 2, 5, MOD_SHIFT },    // char 79 : O
    { 3, 5, MOD_SHIFT },    // char 80 : P
    { 2, 1, MOD_SHIFT },    // char 81 : Q
    { 2, 0, MOD_SHIFT },    // char 82 : R
    { 5, 3, MOD_SHIFT },    // char 83 : S
    { 2, 3, MOD_NO },    // char 84 : T
    { 3, 4, MOD_SHIFT },    // char 85 : U
    { 6, 3, MOD_SHIFT },    // char 86 : V
    { 3, 1, MOD_SHIFT },    // char 87 : W
    { 7, 5, MOD_SHIFT },    // char 88 : X
    { 6, 5, MOD_SHIFT },    // char 89 : Y
    ...
    { 5, 6, MOD_SHIFT },    // char 196 : Ä
    {-1, -1, MOD_NO},    // char 197 unmapped
    {-1, -1, MOD_NO},    // char 198 unmapped
    { 7, 3, MOD_SHIFT | MOD_CEDILLE },    // char 199 : Ç
    ...
    { 2, 4, MOD_AGRAVE | MOD_SHIFT },    // char 204 : Ì
    { 2, 4, MOD_ACUTE | MOD_SHIFT },    // char 205 : Í
    { 2, 4, MOD_ACIRC | MOD_SHIFT },    // char 206 : Î
    {-1, -1, MOD_NO},    // char 207 unmapped
    {-1, -1, MOD_NO},    // char 208 unmapped
    {-1, -1, MOD_NO},    // char 209 unmapped
    { 2, 5, MOD_AGRAVE | MOD_SHIFT },    // char 210 : Ò
    { 2, 5, MOD_ACUTE | MOD_SHIFT },    // char 211 : Ó
    { 2, 5, MOD_ACIRC | MOD_SHIFT },    // char 212 : Ô
    {-1, -1, MOD_NO},    // char 213 unmapped
    { 5, 4, MOD_SHIFT },    // char 214 : Ö
    {-1, -1, MOD_NO},    // char 215 unmapped
    {-1, -1, MOD_NO},    // char 216 unmapped
    { 3, 4, MOD_AGRAVE | MOD_SHIFT },    // char 217 : Ù
    { 3, 4, MOD_ACUTE | MOD_SHIFT },    // char 218 : Ú
    { 3, 4, MOD_ACIRC | MOD_SHIFT },    // char 219 : Û
    { 3, 6, MOD_SHIFT },    // char 220 : Ü
    {-1, -1, MOD_NO},    // char 221 unmapped
    {-1, -1, MOD_NO},    // char 222 unmapped
    { 1, 6, MOD_NO },    // char 223 : ß
    { 4, 3, MOD_AGRAVE },    // char 224 : à
    { 4, 3, MOD_ACUTE },    // char 225 : á
    { 4, 3, MOD_ACIRC },    // char 226 : â
    {-1, -1, MOD_NO},    // char 227 unmapped
    { 5, 6, MOD_NO },    // char 228 : ä
    {-1, -1, MOD_NO},    // char 229 unmapped
    {-1, -1, MOD_NO},    // char 230 unmapped
    { 7, 3, MOD_CEDILLE },    // char 231 : ç
    { 3, 0, MOD_AGRAVE },    // char 232 : è
    { 3, 0, MOD_ACUTE },    // char 233 : é
    { 3, 0, MOD_ACIRC },    // char 234 : ê
    {-1, -1, MOD_NO},    // char 235 unmapped
    { 2, 4, MOD_AGRAVE },    // char 236 : ì
    { 2, 4, MOD_ACUTE },    // char 237 : í
    { 2, 4, MOD_ACIRC },    // char 238 : î
    {-1, -1, MOD_NO},    // char 239 unmapped
    {-1, -1, MOD_NO},    // char 240 unmapped
    {-1, -1, MOD_NO},    // char 241 unmapped
    { 2, 5, MOD_AGRAVE },    // char 242 : ò
    { 2, 5, MOD_ACUTE },    // char 243 : ó
    { 2, 5, MOD_ACIRC },    // char 244 : ô
    {-1, -1, MOD_NO},    // char 245 unmapped
    { 5, 4, MOD_NO },    // char 246 : ö
    {-1, -1, MOD_NO},    // char 247 unmapped
    {-1, -1, MOD_NO},    // char 248 unmapped
    { 3, 4, MOD_AGRAVE },    // char 249 : ù
    { 3, 4, MOD_ACUTE },    // char 250 : ú
    { 3, 4, MOD_ACIRC },    // char 251 : û
    { 3, 6, MOD_NO },    // char 252 : ü
...
#define shiftWritePin output_pin[SHIFT.output]
